...
namespace Xceed.Words.NET
{
    ...
    public abstract class Chart
    {
        ...
        protected Chart()
        {
            ...
            if (IsAxisExist)
            {
                ...
                var gapWidth = ChartXml.Element(XName.Get("gapWidth", DocX.c.NamespaceName));
                if (gapWidth != null)
                {
    ...
    public class Series
    {
        ...
        private readonly XElement _strCache;
        private readonly XElement _numCache;
        ...
        public Series(String name)
        {
            ...
            Xml = new XElement(XName.Get("ser", DocX.c.NamespaceName),
