            ...
            set
            {
                ...
                if (temp - (int)temp == 0)
                {
                    if (value > 0 && value < 1639)
                    {
                        ...
                        throw new ArgumentOutOfRangeException("Size", "Value must be in the range 0 - 1638");
                }
                else
                    throw new ArgumentOutOfRangeException("Size", "Value must be either a whole or half number, examples: 32, 32.5");
            }
        }
            ...
            set
            {
                ...
                if (temp - (int)temp == 0)
                {
                    if (value > -1585 && value < 1585)
                        ...
                        throw new ArgumentOutOfRangeException("Spacing", "Value must be in the range: -1584 - 1584");
                }
                else
                    throw new ArgumentOutOfRangeException("Spacing", "Value must be either a whole or acurate to one decimal, examples: 32, 32.1, 32.2, 32.9");
            }
        }
